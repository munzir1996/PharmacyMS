										...
										<form method="POST" enctype="multipart/form-data" action="{{route('profile.update',auth()->user())}}">
											...
											<div class="row form-row">
												...
												<div class="col-12">
													<div class="form-group">
														<label>email</label>
														<input class="form-control" name="email" type="text" value="{{auth()->user()->email}}" placeholder="Email" required>
													</div>
												</div>
												@can('edit-role')
												<div class="col-12">
													<div class="form-group">
														<label>Role</label>
														<select class="form-control select edit_role" name="role" required>
